...
\restrict dr3yQPcVBzpXjHV0gxM1yCLUFqr3fAdtcvKK8fGGDgbreBVNCQYgsRgs8wo9U3j
...
--
-- Name: api_keys; Type: TABLE; Schema: public; Owner: radar
--
...
ALTER TABLE public.api_keys OWNER TO radar;
...
CREATE TABLE public.jobs (
    ...
    CONSTRAINT jobs_interview_stage_check CHECK (((interview_stage)::text = ANY ((ARRAY[''::character varying, 'Phone screen'::character varying, 'Technical'::character varying, 'Final round'::character varying, 'Offer'::character varying, 'Rejected'::character varying])::text[]))),
    CONSTRAINT jobs_opportunity_score_check CHECK (((opportunity_score IS NULL) OR ((opportunity_score >= 0) AND (opportunity_score <= 100)))),
    CONSTRAINT jobs_remote_check CHECK (((remote)::text = ANY ((ARRAY['Yes'::character varying, 'No'::character varying, 'Hybrid'::character varying, 'Unknown'::character varying])::text[]))),
    CONSTRAINT jobs_response_status_check CHECK (((response_status)::text = ANY ((ARRAY[''::character varying, 'No response'::character varying, 'Viewed'::character varying, 'Replied'::character varying, 'Rejected'::character varying])::text[]))),
    CONSTRAINT jobs_visa_sponsorship_check CHECK (((visa_sponsorship)::text = ANY ((ARRAY['Yes'::character varying, 'No'::character varying, 'Unknown'::character varying])::text[])))
);
...
--
-- Name: jobs_id_seq; Type: SEQUENCE; Schema: public; Owner: radar
--
...
ALTER SEQUENCE public.jobs_id_seq OWNER TO radar;

--
-- Name: jobs_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: radar
--
...
--
-- Name: users; Type: TABLE; Schema: public; Owner: radar
--
...
ALTER TABLE public.users OWNER TO radar;
...
--
-- Name: api_keys api_keys_key_hash_key; Type: CONSTRAINT; Schema: public; Owner: radar
--
...
--
-- Name: api_keys api_keys_pkey; Type: CONSTRAINT; Schema: public; Owner: radar
--
...
--
-- Name: jobs jobs_job_hash_key; Type: CONSTRAINT; Schema: public; Owner: radar
--

ALTER TABLE ONLY public.jobs
    ADD CONSTRAINT jobs_job_hash_key UNIQUE (job_hash);


--
-- Name: jobs jobs_pkey; Type: CONSTRAINT; Schema: public; Owner: radar
--
...
--
-- Name: users users_email_key; Type: CONSTRAINT; Schema: public; Owner: radar
--
...
--
-- Name: users users_pkey; Type: CONSTRAINT; Schema: public; Owner: radar
--
...
--
-- Name: idx_api_keys_key_hash; Type: INDEX; Schema: public; Owner: radar
--
...
--
-- Name: idx_api_keys_user_id; Type: INDEX; Schema: public; Owner: radar
--
...
--
-- Name: idx_applications_user_stage; Type: INDEX; Schema: public; Owner: radar
--

CREATE INDEX idx_applications_user_stage ON public.applications USING btree (user_id, stage) WHERE (user_id IS NOT NULL);
...
--
-- Name: idx_device_tokens_user_id; Type: INDEX; Schema: public; Owner: radar
--

CREATE INDEX idx_device_tokens_user_id ON public.device_tokens USING btree (user_id) WHERE (user_id IS NOT NULL);
...
--
-- Name: idx_users_plan; Type: INDEX; Schema: public; Owner: radar
--
...
--
-- Name: jobs trg_jobs_updated_at; Type: TRIGGER; Schema: public; Owner: radar
--
...
--
-- Name: applications trg_sync_application_to_opportunity; Type: TRIGGER; Schema: public; Owner: radar
--

CREATE TRIGGER trg_sync_application_to_opportunity AFTER INSERT OR UPDATE OF stage ON public.applications FOR EACH ROW EXECUTE FUNCTION public.sync_application_to_opportunity();


--
-- Name: users trg_users_updated_at; Type: TRIGGER; Schema: public; Owner: radar
--
...
--
-- Name: api_keys api_keys_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: radar
--
...
--
-- Name: applications applications_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: radar
--
...
--
-- Name: device_tokens device_tokens_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: radar
--
...
\unrestrict dr3yQPcVBzpXjHV0gxM1yCLUFqr3fAdtcvKK8fGGDgbreBVNCQYgsRgs8wo9U3j
